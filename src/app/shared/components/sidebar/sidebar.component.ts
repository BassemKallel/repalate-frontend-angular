...
export class SidebarComponent {
  ...
  navItems: NavItem[] = [
    { label: 'Overview', icon: 'dashboard', route: '/dashboard/announcements', roles: ['MERCHANT', 'INDIVIDUAL', 'ASSOCIATION'] },
    { label: 'Announcements', icon: 'campaign', route: '/dashboard/announcements', roles: ['MERCHANT'] },
    { label: 'Create Announcement', icon: 'add_circle', route: '/dashboard/announcements/create', roles: ['MERCHANT'] },
